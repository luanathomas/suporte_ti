...
<body>
    ...
    <div id="container">
        <form class="form" method="post" action='processa.php'>
            ...
            <div>
                <center><u><h2> Usuário </h2></u></center>
            </div>

            <div>
                <center><h3> Esse sistema tem o objetivo de auxiliá-lo em seus problemas com equipamentos de 
                ...
                e contate o administrador do sistema. </h3></center>
            </div>

            <div>
            <center><u><h2> Administrador </h2></u></center>
            </div>

            <div>
                <center><h3> Este sistema de recomendação com RBC possui o intuito de auxiliar o usuário 
                    ...
                    primários, problemas secundários e soluções. </h3></center>
            </div>
